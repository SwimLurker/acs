...
public class ParameterValueStruct implements Serializable {
    ...
    public ParameterValueStruct(OMElement element) throws DataBindingException {
        ...
        if(type==null||type.equals("")){
            ...
            log.warn("Value type is null ,set to string");
            this.setValue(ConverterUtil.convertToString(content));
            ...
            if(content.equals("")){
                ...
                this.setValue(ConverterUtil.convertToUnsignedInt(content));
            }
        }else if(type.equals("boolean")){
            if(content.equals("")){
                this.setValue(null);
            }else{
                this.setValue(ConverterUtil.convertToBoolean(content));
            }
            ...
            if(content.equals("")){
                ...
                try {
                    this.setValue(ConverterUtil.convertToDateTime(content));
                } catch (Exception e) {
            ...
            try {
                this.setValue(ConverterUtil.convertToBase64Binary(content));
            } catch (Exception e) {
                throw new DataBindingException(TR069Constants.ERROR_DATA_BINDING,"Value type error",e);
            }
        }else if(type.equals("object")){
            this.setValue(ConverterUtil.convertToAnyType(content));
     ...
     */
    public static ParameterValueStruct parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
