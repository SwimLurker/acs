 ...
 * Time: ÉÏÎç4:12
 */
public class MinusFunction implements IFunction , Cloneable{
    private String arg1 = null;
    private String arg2 = null;

    public void setArgs(String[] args) throws InstructionException {
        if(args.length != 2){
            throw new InstructionException("Invaid arguments number for minus function");
        }
    ...
    public String execute(InstructionContext context) throws InstructionException {
        try{
            ...
            throw new InstructionException("Execute minus function failed", exp);
        }
    }
