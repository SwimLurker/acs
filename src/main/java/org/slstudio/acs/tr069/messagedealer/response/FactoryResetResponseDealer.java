...
import org.slstudio.acs.tr069.databinding.response.FactoryResetResponse;
 ...
 * Time: ÏÂÎç9:09
 */
public class FactoryResetResponseDealer extends AbstractResponseDealer {
    @Override
    protected TR069Message convertToTR069Message(SOAPEnvelope envelope) throws TR069Exception {
        return FactoryResetResponse.fromEnvelope(envelope);
    }
}
