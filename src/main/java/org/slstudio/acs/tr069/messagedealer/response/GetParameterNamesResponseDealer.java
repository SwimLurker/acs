...
import org.slstudio.acs.tr069.databinding.response.GetParameterNamesResponse;
 ...
 * Time: ÏÂÎç9:12
 */
public class GetParameterNamesResponseDealer extends AbstractResponseDealer {
    @Override
    protected TR069Message convertToTR069Message(SOAPEnvelope envelope) throws TR069Exception {
        return GetParameterNamesResponse.fromEnvelope(envelope);
    }
}
