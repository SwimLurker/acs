...
import org.slstudio.acs.tr069.databinding.response.GetParameterAttributesResponse;
 ...
 * Time: ÏÂÎç9:10
 */
public class GetParameterAttributesResponseDealer extends AbstractResponseDealer {
    @Override
    protected TR069Message convertToTR069Message(SOAPEnvelope envelope) throws TR069Exception {
        return GetParameterAttributesResponse.fromEnvelope(envelope);
    }
}
