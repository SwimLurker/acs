...
import org.slstudio.acs.tr069.databinding.response.SetParameterValuesFaultResponse;
 ...
 * Time: ÏÂÎç9:30
 */
public class SetParameterValuesFaultDealer extends AbstractResponseDealer {
    @Override
    protected TR069Message convertToTR069Message(SOAPEnvelope envelope) throws TR069Exception {
        return SetParameterValuesFaultResponse.fromEnvelope(envelope);
    }
