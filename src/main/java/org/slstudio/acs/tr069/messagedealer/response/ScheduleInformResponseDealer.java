...
import org.slstudio.acs.tr069.databinding.response.ScheduleInformResponse;
 ...
 * Time: ÏÂÎç9:15
 */
public class ScheduleInformResponseDealer extends AbstractResponseDealer {
    @Override
    protected TR069Message convertToTR069Message(SOAPEnvelope envelope) throws TR069Exception {
        return ScheduleInformResponse.fromEnvelope(envelope);
    }
}
